...
<div class="col-lg-12">
      <div class="card">
        <div class="card-header">
          <strong>HomeLoan Information</strong>
            <small> Form</small>
              </div>
...
<div class="form-group">
                    ...
                    <label for="name" class=" form-control-label">Gaurantor Information <hr></label>
                     ...
                     <div class="form-group">
                      ...
                      <div class="guarantor"> 
                    <label for="name" class=" form-control-label">HomeLoan Information <hr></label>
                  </div>
                      
                     <div class="form-group">
                     <div class="col-lg-6">
                      <label for="name" class=" form-control-label">Do You Own or Rented Your House?</label>
                    </div>
                   ...
                   <div class="form-group">
                      <label for="name" class=" form-control-label">Mortgadge</label>
                      <input type="text" name="details"  placeholder="Enter Mortgadge" class="form-control">
                     </div>
