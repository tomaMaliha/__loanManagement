      ...
      <div class="wrapper">
        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <form method="POST" role="form" action="{{route('loaninfocar.create')}}">
              @csrf
              ...
              <div class="card-body card-block">
                ...
                <div class="form-group col-lg-4">
                  ...
                  <input type="text" name="interest_rate"  placeholder="Enter Interest Rate" class="form-control">
                </div>

                <div class="form-group col-lg-4">
                  <label for="name" class=" form-control-label">Minimun Age requirement</label>
                  <input type="text" name="min_age_requirement"  placeholder="Enter Age requirement" class="form-control">
                </div>

                <div class="form-group col-lg-4">
                  <label for="name" class=" form-control-label">Maximum Age requirement</label>
                  <input type="text" name="max_age_requirement"  placeholder="Enter Age requirement" class="form-control">
                </div>

                <div class="form-group col-lg-4">
                  <label for="name" class=" form-control-label">Min. Salary requirement  </label>
                  <input type="text" name="min_income"  placeholder="Enter Min. Salary requirement  " class="form-control">
                </div>

                <div class="form-group col-lg-4">
                  <label for="name" class=" form-control-label">Financial Amount (minimun)  </label>
                  <input type="text" name="min_financial_amount"  placeholder="Enter Min. Salary requirement  " class="form-control">
                </div>

                <div class="form-group col-lg-4">
                  <label for="name" class=" form-control-label">Financial Amount (Maximum)  </label>
                  <input type="text" name="max_financial_amount"  placeholder="Enter Min. Salary requirement  " class="form-control">
                </div>
                ...
                <div class="form-group col-lg-4">
                  ...
                  <input type="text" name="min_loan_tenure_years"  placeholder="Enter Loan Tenure years" class="form-control">
                </div>

                <div class="form-group col-lg-4">
                  <label for="name" class=" form-control-label">Loan Tenure (Max) </label>
                  <input type="text" name="max_loan_tenure_years"  placeholder="Enter Loan Tenure years" class="form-control">
                </div>
                ...
                <div class="form-group col-lg-4">
                  <label for="name" class=" form-control-label">Car Insurance</label>
                      <input type="text" name="details[car_insurance]"  placeholder="Enter Car Insurance" class="form-control">
                </div>

                <div class="form-group col-lg-4">
                  <label for="name" class=" form-control-label">Allows joint applicant?</label>
                      <input type="text" name="details[car_joint_applicant]"  placeholder="Enter Car Insurance" class="form-control">
                </div>


                <div class="form-group col-lg-4">
                  <label for="name" class=" form-control-label">Security</label>
                      <input type="text" name="details[car_security]"  placeholder="Enter Security Charge" class="form-control">
                </div>
