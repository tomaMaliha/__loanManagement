...
<body>
  <style>
    ...
    <div class="container">
      <div class="wrapper">
        <h1>Perosnal Loan Information</h1>
        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <form method="POST" role="form" action="{{route('loaninfopersonal.create')}}">
              @csrf
              ...
              <input type="text" name="details[Purpose_Personal_Loan]"  placeholder="Enter Purpose of Personal Loan" class="form-control">
                </div>

                <div class="form-group col-lg-4">
                  <label for="name" class=" form-control-label">Property Ownership</label>
              <input type="text" name="details[Ownership]"  placeholder="Enter Property Ownership" class="form-control">
                </div>
