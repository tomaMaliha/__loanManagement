      ...
      <div class="wrapper">
        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <form method="POST" role="form" action="{{route('loaninfohome.create')}}">
              @csrf
              ...
              <div class="card-body card-block">
                ...
                <div class="form-group col-lg-4">
                  ...
                  <input type="number" name="interest_rate"  placeholder="Enter Interest Rate" class="form-control">
                </div>

                <div class="form-group col-lg-4">
                  <label for="name" class=" form-control-label">Minimun Age requirement</label>
                  <input type="number" name="min_age_requirement"  placeholder="Enter Age requirement" class="form-control">
                </div>

                <div class="form-group col-lg-4">
                  <label for="name" class=" form-control-label">Maximum Age requirement</label>
                  <input type="number" name="max_age_requirement"  placeholder="Enter Age requirement" class="form-control">
                </div>

                <div class="form-group col-lg-4">
                  <label for="name" class=" form-control-label">Min. Salary requirement  </label>
                  <input type="number" name="min_income"  placeholder="Enter Min. Salary requirement  " class="form-control">
                </div>

                <div class="form-group col-lg-4">
                  <label for="name" class=" form-control-label">Financial Amount (minimun)  </label>
                  <input type="number" name="min_financial_amount"  placeholder="Enter Min. Salary requirement  " class="form-control">
                </div>

                <div class="form-group col-lg-4">
                  <label for="name" class=" form-control-label">Financial Amount (Maximum)  </label>
                  <input type="number" name="max_financial_amount"  placeholder="Enter Min. Salary requirement  " class="form-control">
                </div>

                <div class="form-group col-lg-4">
                  <label for="name" class=" form-control-label">Islamic/Conventional</label>
                  <input type="text" name="islamic"  placeholder="Enter Islamic/Conventional type" class="form-control">
                </div>
                ...
                <div class="form-group col-lg-4">
                  ...
                  <input type="number" name="min_loan_tenure_years"  placeholder="Enter Loan Tenure years" class="form-control">
                </div>

                <div class="form-group col-lg-4">
                  <label for="name" class=" form-control-label">Loan Tenure (Max) </label>
                  <input type="number" name="max_loan_tenure_years"  placeholder="Enter Loan Tenure years" class="form-control">
                </div>

                <div class="form-group col-lg-4">
                  <label for="name" class=" form-control-label">Employment Eligibility </label>
                  <input type="text" name="emp_eligibility"  placeholder="Enter Employment Eligibility " class="form-control">
                </div>

                <div class="form-group col-lg-4">
                  <label for="name" class=" form-control-label">Source of Income</label>
                  <input type="text" name="source_income"  placeholder="Enter Source of Income " class="form-control">
                </div>

                <div class="form-group col-lg-4">
                  <label for="name" class=" form-control-label">Max. loan tenure</label>
                  <input type="text" name="max_loan_tenure"  placeholder="Enter Max. loan tenure " class="form-control">
                </div>

                <div class="form-group col-lg-4">
                  <label for="name" class=" form-control-label">Approval Duration</label>
                  <input type="text" name="approve_time"  placeholder="Enter Approval Duration" class="form-control">
                </div>

                <div class="form-group col-lg-4">
                  <label for="name" class=" form-control-label">Service Charge</label>
                  <input type="text" name="service_charge"  placeholder="Enter Service Charge" class="form-control">
                </div>

                <div class="form-group col-lg-4">
                  <label for="name" class=" form-control-label">Late Payment Charges</label>
                  <input type="text" name="late_payment"  placeholder="Enter Late Payment Charges" class="form-control">
                </div>

                <div class="form-group col-lg-4">
                  <label for="name" class=" form-control-label">Before Loan</label>
                  <input type="text" name="before_loan"  placeholder="Enter Late Payment Charges" class="form-control">
                </div>
                ...
                <div class="form-group col-lg-4">
                  ...
                  <input type="text" name="details[home_document]"  placeholder="Enter Documents Information" class="form-control">
                </div>


                <div class="form-group col-lg-4">
                  <label for="name" class=" form-control-label">Documents Fees</label>
                  <input type="text" name="details[home_document_fees]"  placeholder="Enter Documents Fees" class="form-control">
                </div>


                <div class="form-group col-lg-4">
                  <label for="name" class=" form-control-label">Property Mortgadge Charge</label>
                  <input type="text" name="details[home_mortgadge_charge]"  placeholder="Enter Mortgadge Charge" class="form-control">
                </div>

                <div class="form-group col-lg-4">
                  <label for="name" class=" form-control-label">Property Valuation Charge</label>
                  <input type="text" name="details[home_valuation_charge]"  placeholder="Enter Property Valuation Charge" class="form-control">
                </div>
